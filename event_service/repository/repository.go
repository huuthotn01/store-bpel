...
type IEventServiceRepository interface {
	...
	UpdateImage(ctx context.Context, eventId int, imageUrl string) error
}
...
func (r *eventServiceRepository) UpdateImage(ctx context.Context, eventId int, imageUrl string) error {
